...
- `/authorize` - marks the "authorized" field "Y" (acts as 2-factor-auth before /reimburse can be used)
- `/find` - returns the ID, "authorized", and "reimbursed" data of a record given the name, memo, and amount
- TODO: `/reimburse` - duh
### Milestones
