...
This guide will walk you through the steps needed to set up Hack Night.
## Week Before
The week before Hack Night, the Events Division should ensure the Design team is ready to create the weekly badge for Hack Night. A designer is tasked with coming up with a theme for the badge and creating a design. See [Badges](https://www.notion.so/282181f3b6ed80c39c25e1d2e582c9d7) for more information on this process.
...
### Upstairs
- [ ] Set up badges table
	- [ ] Plug in an extension cord to the wall right in front of the stairs
	- [ ] Plug in a power strip to the extension cord
...
- [ ] Set up tables
	...
	- [ ] Set up tables and chairs in such a way to maximize space usage (vague to let people try new layouts)
- [ ] Close all meeting rooms
	- [ ] Either with a key from downstairs or a lock picking set, lock all doors to the meeting room areas near the kitchen
- [ ] Kick out non-hack night students
	- [ ] We have a reservation for the entire second floor starting at the beginning of Hack Night. If any students are still on the second floor doing homework or from another club we have permission to ask them to leave the space and go downstairs.
	- [ ] The ONLY exception to this is a Bechtel TA using the space to perform their duties.
<empty-block/>